    ...
    return (
        <section className="relative isolate bg-white py-24 md:py-32">
            <div className="mx-auto max-w-6xl px-6 lg:px-0">
                <div className="max-w-full h-full px-5 md:px-10">
                    <div className="flex flex-col lg:flex-row space-y-10 lg:space-y-0 justify-between rounded-xl bg-black/95 p-6 shadow-2xl md:p-12">
                        <div className="lg:w-[19rem] text-center lg:text-left   ">
                        ...
                        <div className="flex mx-auto text-center flex-col sm:flex-row space-y-6 sm:space-y-0 sm:items-center sm:justify-center sm:space-x-8 md:space-x-16">
                ...
                <div className="relative isolate -z-[1] mx-auto -mt-28 rounded-2xl bg-gray-100/60 px-6 pt-36">
                    ...
                    <div className="mt-10 z-30 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                        {companies.map((company, i) => (
                            <div key={i}>
                                <div className="group relative before:absolute before:-inset-2.5 before:rounded-[20px] before:bg-gray-100 before:opacity-0 hover:before:opacity-100">
                                    <a href={company.siteLink} className="relative overflow-hidden rounded-lg bg-gray-100 ring-1 ring-gray-900/10">
                                        <Image
