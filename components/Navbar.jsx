...
const Navbar = () => {
    ...
    return (
        <header className='relative z-10 overflow-hidden'>
            <nav>
                <div className='bg-black border-b border-gray-600 flex items-center justify-between py-5 px-6 lg:px-8'>
                    ...
                    <div className='flex lg:hidden'>
                        {mobilemenu ? (
                            <button
                                ...
                                type='button' className='-m-2.5 rounded-md p-4 text-gray-100'>
                    ...
                    <div className="hidden lg:ml-8 lg:flex lg:flex-none lg:gap-4 lg:items-center lg:pl-8">
                        <a href="#" className='text-gray-300'>Search</a>
